...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public Motorista build() {
            Objects.requireNonNull(this.nome, "Necessario informar nome do motorista!!!");
            Objects.requireNonNull(this.habilitacao, "Necessario informar habilitação do motorista!!!");
